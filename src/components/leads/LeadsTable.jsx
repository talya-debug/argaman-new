          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-slate-50">
                <TableHead className="text-right font-semibold w-60">שם ליד</TableHead>
                <TableHead className="text-right font-semibold">פרטי יצירת קשר</TableHead>
                <TableHead className="text-right font-semibold">קישור לתיקיית לקוח</TableHead>
                <TableHead className="text-right font-semibold">סטטוס</TableHead>
                <TableHead className="text-right font-semibold">אחראי</TableHead>
                <TableHead className="text-right font-semibold">תאריך פולואפ</TableHead>
              ...
              {leads.map((lead) => (
                ...
                >
                        ...
                        <div className="space-y-1 flex-1">
                          <div className="flex items-center gap-2">
                            {isEditing(lead.id, 'name') ? (
                              ...
                              <span
                                className="font-medium text-slate-900 cursor-pointer hover:text-blue-600 flex-1"
                    ...
                    <div className="space-y-2">
                      ...
                      {(lead.email || isEditing(lead.id, 'email')) ? (
                        ...
                        <Button
                          ...
                          className="h-6 text-xs text-slate-400 hover:text-blue-600 p-0"
                        >
                          + הוסף מייל
                        </Button>
                      )}
                  ...
                  <TableCell className="text-right">
                    ...
                    >
                      <SelectTrigger className="text-right text-xs h-8">
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                           <Button
                            ...
                            className={`h-8 w-8 p-0 ${leadQuotes[lead.id] && leadQuotes[lead.id].length > 0 ? 'text-blue-600 hover:bg-blue-50' : 'text-slate-500 hover:bg-slate-100'}`}
                          >
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <Button
                            ...
                            size="sm"
                            onClick={() => onEdit(lead)}
                            className="hover:bg-purple-50 hover:text-purple-700 text-purple-600 h-8 w-8 p-0"
                          >
                      ...
                      <AlertDialog>
                        <AlertDialogTrigger asChild>
                          <Button
                            variant="ghost"
                            size="sm"
                            className="hover:bg-red-50 hover:text-red-700 text-red-600 h-8 w-8 p-0"
                          >
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            <AlertDialogTitle className="text-right">מחיקת ליד</AlertDialogTitle>
