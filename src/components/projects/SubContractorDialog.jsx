                ...
                <div className="bg-white p-1 rounded-lg">
                    ...
                    <div className="p-6 bg-white">
                        <form onSubmit={handleSubmit} className="space-y-6 text-slate-800">
                            <div>
                                <Label htmlFor="contractor-name" className="text-gray-700 font-semibold">שם הקבלן *</Label>
                                <Input
                                    id="contractor-name"
                            ...
                            <div>
                                <Label htmlFor="work-field" className="text-gray-700 font-semibold">תחום עבודה *</Label>
                                <Select 
                            ...
                            <div>
                                <Label htmlFor="work-type" className="text-gray-700 font-semibold">סוג העבודה</Label>
                                <Input
                                    id="work-type"
                            ...
                            <div>
                                <Label htmlFor="amount" className="text-gray-700 font-semibold">סכום לתשלום (₪) *</Label>
                                <Input
                                    id="amount"
                                    type="number"
                                    min="0"
                            ...
                            <div>
                                <Label htmlFor="payment-status" className="text-gray-700 font-semibold">סטטוס תשלום</Label>
                                <Select 
