                                    ...
                                    <Table>
                                        ...
                                        <TableBody>
                                            {localQuoteLines && localQuoteLines.map((line) => {
                                                if (line.is_header) {
                                                    return (<TableRow key={line.id} className="bg-[rgba(96,165,250,0.1)]"><TableCell colSpan={7} className="text-right font-bold text-blue-900 text-lg py-3">{line.clause_number && <span className="text-gray-500 ml-2">{line.clause_number}</span>}{line.name_snapshot || line.model_snapshot}</TableCell></TableRow>);
                                                }
                                                const entries = invoicesData[line.id] || [];
