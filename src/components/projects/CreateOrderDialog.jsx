                    ...
                    <div className="p-6 bg-white">
                        <form onSubmit={handleSubmit} className="space-y-4 text-gray-900">
                            <div className="bg-[rgba(96,165,250,0.1)] p-3 rounded-lg border border-blue-200">
                                <p className="text-sm text-gray-700">כמות נותרת להזמנה: <span className="font-bold text-[#60a5fa]">{remainingQuantity}</span></p>
                            </div>

                            <div>
                                <Label htmlFor="quantity" className="text-gray-700 font-semibold">כמות להזמנה *</Label>
                                <Input
                                    id="quantity"
                                    type="number"
                                    min="0.01"
                            ...
                            <div>
                                <Label htmlFor="supplier" className="text-gray-700 font-semibold">ספק</Label>
                                <Input
                                    id="supplier"
                                    value={supplierName}
                            ...
                            <div>
                                <Label htmlFor="responsible" className="text-gray-700 font-semibold">אחראי הזמנה *</Label>
                            ...
                            <div>
                                <Label htmlFor="due-date" className="text-gray-700 font-semibold">תאריך יעד</Label>
                                <Input
                                    id="due-date"
                                    type="date"
                                    value={dueDate}
